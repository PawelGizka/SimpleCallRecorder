...
public class RecordingDetailFragment extends Fragment {
    ...
    private void setUpScreen(){
        ...
        Cursor contactCursor = getActivity().getContentResolver().query(
                contactUri, new String[]{ContactsContract.PhoneLookup.DISPLAY_NAME, ContactsContract.PhoneLookup.PHOTO_ID},
                null, null, null);
        ActionBar actionBar = ((ActionBarActivity) getActivity()).getSupportActionBar();
        if(contactCursor != null && contactCursor.moveToFirst()) {
            String displayName = contactCursor.getString(contactCursor.getColumnIndex(ContactsContract.PhoneLookup.DISPLAY_NAME));
            if(displayName != null) {
